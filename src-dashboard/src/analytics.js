// Analytics functionality for settings page
// This script handles the analytics visualizations in the Overall Analytics tab
...
function initializeAnalytics() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    // Set up tab switching for settings page
    ...
    tabs.forEach(tab => {
      tab.addEventListener('click', function() {
        ...
        // If the analytics tab was clicked, initialize analytics
        if (tabId === 'overall-analytics') {
